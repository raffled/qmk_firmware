 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Nav  | GUI  | ALT  |Lower |    Space    |    Space    |Raise | Alt  | GUI  | Ctrl | 
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_2x2u( \
  ...
  NAV,     KC_LGUI, KC_LALT, LOWER,      KC_SPC,            KC_SPC,       RAISE,   KC_RALT, KC_RGUI, KC_RCTL  \
),
...
[_RAISE] = LAYOUT_preonic_2x2u( \
  ...
  _______, _______, DEV,     _______,       _______,         _______,     _______, _______, _______, _______  \
),
